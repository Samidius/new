MorozzzCoin-qt: Qt4 GUI for MorozzzCoin
===============================
...
Alternatively, install Qt Creator and open the `MorozzzCoin-qt.pro` file.

An executable named `MorozzzCoin-qt` will be built.
...
A warning for people using the *static binary* version of MorozzzCoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of MorozzzCoin is linked against libdb5.3.
...
installed causes MorozzzCoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
