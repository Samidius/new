...
const string strMessageMagic = "MorozzzCoin2.0 Signed Message:\n";
...
void ThreadScriptCheck(void *) {
    ...
    RenameThread("MorozzzCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB &txdb, CBlockIndex *pindex, bool fJustCheck) {
    ...
    bool fEnforceBIP30 = true; // Always active in MorozzzCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const {
    ...
    if (fProofOfStake) {
        ...
        // MorozzzCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes) {
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes) {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MorozzzCoin",
...
bool LoadBlockIndex(bool fAllowNew) {
    ...
    if (mapBlockIndex.empty()) {
        ...
        const char *pszTimestamp = "No mine - no bad";
        CTransaction txNew;
        ...
        block.nNonce = 1533747187; // !fTestNet ? 1575379 : 46534;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x98fe9fcd8b0122eb5c27b567070aacbba0796ff922c3244302f6e86e5b8c6ecb"));
