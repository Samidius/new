...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ZZZ");
    case mBTC: return QString("mZZZ");
    case uBTC: return QString::fromUtf8("μZZZ");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("MorozzzCoins"));
    case mBTC: return QString(QObject::tr("Milli-MorozzzCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-MorozzzCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
